class seq_single_burst_2bytes extends uvm_sequence#(seq_item);
`uvm_object_utils(seq_single_burst_2bytes)

seq_item req;

function new(string name="seq_single_burst_2bytes");
super.new(name);
endfunction

task body();

//-----------SIZE  HALF WORD(2 BYTES)-----------------
